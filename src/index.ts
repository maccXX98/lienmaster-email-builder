 ...
 * 
 * 向后兼容：所有现有导入方式保持不变
 * - import { EmailBuilder } from 'lienmaster-email-builder' ✅
 * - import EmailBuilder from 'lienmaster-email-builder' ✅
 * 
 * 按需加载 HtmlEditor（推荐懒加载 CodeMirror）：
 * - import { HtmlEditor } from 'lienmaster-email-builder/html-editor' ✅
 */
...
// 默认导出（支持 import EmailBuilder from 'lienmaster-email-builder'）
